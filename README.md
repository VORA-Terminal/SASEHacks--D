...
* **[Google Gemini API](https://ai.google.dev/)** - Powered by `google-generativeai` for dynamic flashcard generation and processing flashcard data from pdfs and doc files
...
* **[ElevenLabs API](https://elevenlabs.io/)** - Used for text-to-speech functionality 
